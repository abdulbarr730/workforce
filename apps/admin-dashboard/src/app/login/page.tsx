      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, position: "relative" }}>
          ...
          <div>
            ...
            <p style={{ color: "#a5b4fc", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.18em", marginTop: 4 }}>Workforce OS</p>
          </div>
        </div>
        ...
        <div style={{ position: "relative" }}>
          <div style={{
            ...
            <span style={{ color: "rgba(255,255,255,0.75)", fontSize: 12, fontWeight: 500 }}>Admin &amp; HR Command Center</span>
          </div>
      ...
      <div style={{
        ...
        <div className="flex lg:hidden" style={{ alignItems: "center", gap: 12, marginBottom: 40 }}>
          ...
          <div>
            ...
            <p style={{ color: "#64748b", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.18em", marginTop: 3 }}>Workforce OS</p>
          </div>
        </div>
        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ color: "#64748b", fontSize: 14 }}>Sign in to your admin account</p>
          </div>
