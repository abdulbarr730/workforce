...
const assignedTaskSchema = new mongoose.Schema(
  {
    ...
    source: {
      type: String,
      enum: ["ADMIN_DASHBOARD", "TEAMS", "MANUAL", "CRM"],
      default: "ADMIN_DASHBOARD",
      index: true,
    },
    crmQueryId: { type: String, default: "" },
    crmClientName: { type: String, default: "" },
    crmClientPhone: { type: String, default: "" },
    crmClientEmail: { type: String, default: "" },
    crmUrl: { type: String, default: "" },
