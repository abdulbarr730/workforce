...
import { getAllLeavesController, getMyLeavesController } from "../controllers/get-all-leaves.controller";
...
// --- LEAVE ROUTES ---
router.get("/leaves", authorize("SUPER_ADMIN", "ADMIN", "HR", "MANAGER"), getAllLeavesController);
