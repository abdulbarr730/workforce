...
export const createShiftPolicySchema = z.object({
  body: z.object({
    ...
    halfDayAfterTime: z.string().regex(timeRegex, "Invalid halfDayAfterTime format. Use HH:mm"),
    absentAfterTime: z.string().regex(timeRegex, "Invalid absentAfterTime format. Use HH:mm"),
    ...
    eodTriggerTime: z.string().regex(timeRegex, "Invalid eodTriggerTime format. Use HH:mm"),
...
export type CreateShiftPolicyInput = z.infer<typeof createShiftPolicySchema>["body"];