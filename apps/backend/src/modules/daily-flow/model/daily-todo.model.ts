...
const todoItemSchema = new mongoose.Schema(
  {
    ...
    remindDailyUntilDeadline: { type: Boolean, default: false },
    ...
    recurrenceStoppedAt: { type: Date, default: null },
    recurrenceGeneratedFor: { type: String, default: "" },
