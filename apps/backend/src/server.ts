...
import { startActivityEventsCleanupJob } from "./modules/tracking/services/activity-events.cleanup";
...
const startServer = async () => {
  ...
  // Start the background job for deleting 7-day old activity events
  startActivityEventsCleanupJob();
