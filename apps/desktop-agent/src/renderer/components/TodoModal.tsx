  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 }}>
      <div 
        ...
        style={{ background: "#fff", padding: 24, borderRadius: 12, width: 800, boxShadow: "0 10px 25px rgba(0,0,0,0.2)", display: "flex", gap: 32 }}
      >
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          <h2 style={{ margin: "0 0 16px", fontSize: 18, color: "#0f172a" }}>📝 Start of Day: To-Do List</h2>
          <p style={{ margin: "0 0 16px", fontSize: 13, color: "#64748b" }}>Please list your tasks for today. You can <b>Paste</b> or <b>Drop</b> a list here. Press <b>Enter</b> to add a new task.</p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16, maxHeight: "50vh", overflowY: "auto", paddingRight: 8 }}>
            {tasks.map((task, i) => (
              <input
                key={task.id}
          ...
          <div style={{ marginTop: "auto" }}>
            ...
            <button 
              onClick={onClose}
              style={{ width: "100%", padding: "10px", borderRadius: 8, background: "transparent", color: "#64748b", border: "none", cursor: "pointer", marginTop: 8 }}
            >
              Close
            </button>
          </div>
        ...
        {/* Live Preview Column */}
        <div style={{ width: 300, background: "#f8fafc", padding: 20, borderRadius: 8, border: "1px solid #e2e8f0", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", background: "#fff", padding: 12, borderRadius: 6, border: "1px solid #cbd5e1", fontSize: 13, color: "#475569", whiteSpace: "pre-wrap", fontFamily: "monospace" }}>
            {previewText || <span style={{ color: "#94a3b8", fontStyle: "italic" }}>No tasks entered yet...</span>}
          </div>
        </div>
