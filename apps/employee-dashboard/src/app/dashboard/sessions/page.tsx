  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Your daily work session history</p>
      </div>
      ...
      {activeSession ? (
        <div className="bg-white rounded-xl border border-green-200 p-5 mb-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-gray-900">{formatDate(activeSession.loginTime)} at {new Date(activeSession.loginTime).toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit" })}</span>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 mb-6 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-gray-400">No active session. Start the desktop agent to begin your workday.</p>
        </div>
      )}
